...
public class StudentController {
	...
	ResponseEntity<StudentCreateDto> update(@RequestBody StudentCreateDto student,@PathVariable long id){
		StudentCreateDto updated = studentService.update(student,id);
